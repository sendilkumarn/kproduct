...
To build the final jar and optimize the kproduct application for production, run:
...
[doing microservices with jhipster]: https://www.jhipster.tech/documentation-archive/v6.10.0/microservices-architecture/
