package com.sendilkumarn.sample.kproduct.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.sendilkumarn.sample.kproduct.repository..*)" +
            " || within(com.sendilkumarn.sample.kproduct.service..*)" +
            " || within(com.sendilkumarn.sample.kproduct.web.rest..*)"
    )
