...
import com.sendilkumarn.sample.kproduct.config.ApplicationProperties
...
class KproductApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes kproduct.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KproductApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KproductApp::class.java)
